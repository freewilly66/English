...
self.addEventListener('fetch',function(e){
  ...
  if(e.request.url.includes('allorigins')||e.request.url.includes('corsproxy')||e.request.url.includes('codetabs')||e.request.url.includes('thingproxy')||e.request.url.includes('youtube')||e.request.url.includes('anthropic')){
